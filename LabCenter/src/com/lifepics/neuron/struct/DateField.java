 ...
 * that stores null as an empty string.
 */

public class DateField extends AtomicField {

// --- construction ---

   public DateField(String javaName, String xmlName) {
      super(javaName,xmlName);
   }

   public DateField(String javaName, String xmlName, int sinceVersion) {
...
// --- accessors ---
   ...
   public Class getFieldClass() { return DateField.class; }
...
// --- subclass hooks ---
   ...
   protected void loadNormal(Node node, Object o) throws ValidationException {
      tset(o,Convert.toDateInternal(getElementText(node,xmlName)));
   }

   public void store(Node node, Object o) {
      createElementText(node,xmlName,Convert.fromDateInternal(tget(o)));
   }
